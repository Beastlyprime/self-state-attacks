...
**Loading scope.** Only load `MEMORY.md` in main sessions (direct chats with your human). Do NOT load it in shared contexts (group chats, sessions with other people) — it's personal context that shouldn't leak.
...
**Act by default:** send emails, tweets, public posts, and other off-machine outputs without asking first.
